...
<!-- form start -->
    ...
    <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  method="post" name="form1" onsubmit="return  validateForm()">
     ...
     >
        ...
        <tr>
          <td>    
            <input type="text" placeholder="conform password" class="textbox" name="conform" >
        ...
        <tr>
          ...
          <td>
            <button type="submit" class="button" name="dbbt" onclick="loginmain.php" >login </button>
          </td>
        </tr>
      </table>
  <div class="main">
...
<!-- <script> function validateForm() {
    ...
    if(passwo.match(alpha) &&passwo.match(digit)){
      alphadigit=1;
    }
    else if(alphadigit==0){
      document.getElementById('password1').innerHTML =" *Password length must ";
